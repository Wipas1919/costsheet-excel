        ...
        if template_type in type_start_rows:
            ...
            for i, item in enumerate(items):
                ...
                if 'Component' in column_indices:
                    ws[f'C{current_row}'] = item[columns[column_indices['Component']]]
                
                if 'Descriptions' in column_indices:
                    ws[f'D{current_row}'] = item[columns[column_indices['Descriptions']]]
                
                if 'W' in column_indices:
                    ws[f'E{current_row}'] = item[columns[column_indices['W']]]
                
                if 'L' in column_indices:
                    ws[f'F{current_row}'] = item[columns[column_indices['L']]]
                
                if 'H' in column_indices:
                    ws[f'G{current_row}'] = item[columns[column_indices['H']]]
                
                if 'quantity' in column_indices:
                    ws[f'H{current_row}'] = item[columns[column_indices['quantity']]]
                
                if 'Unit' in column_indices:
                    ws[f'I{current_row}'] = item[columns[column_indices['Unit']]]
                
                if 'Unit Price' in column_indices:
                    ws[f'J{current_row}'] = item[columns[column_indices['Unit Price']]]
                
                if 'Amounts' in column_indices:
                    ws[f'K{current_row}'] = item[columns[column_indices['Amounts']]]
                
                if 'Remarks' in column_indices:
                    ws[f'L{current_row}'] = item[columns[column_indices['Remarks']]]
